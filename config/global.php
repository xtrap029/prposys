<?php 
    return [
        ...
        'trans_category_label' => ['Regular Transaction', 'Deposit Transaction', 'Bills Payment', 'Salaries and Overhead Wages', 'Reimbursement', 'Fund Transfer', 'TDSA Bill', 'TDSA Payment', 'AEC Bill', 'AEC Payment'],
        'trans_category_label_filter' => ['All Categories', 'Deposit Transaction', 'Bills Payment', 'Salaries and Overhead Wages', 'Reimbursement', 'Fund Transfer', 'TDSA Bill', 'TDSA Payment', 'AEC Bill', 'AEC Payment'],
        'trans_category_label_filter_2' => ['All', 'Deposit Transaction', 'Bills Payment', 'Salaries and Overhead Wages', 'Reimbursement', 'Fund Transfer', 'TDSA Bill', 'TDSA Payment', 'AEC Bill', 'AEC Payment'],
