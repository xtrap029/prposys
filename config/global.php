<?php 
    return [
        ...
        'trans_category_label' => ['Regular Transaction', 'Deposit Transaction', 'Bills Payment', 'Human Resource', 'Reimbursement', 'Bank Transfer'],
        'trans_category_label_filter' => ['All Categories', 'Deposit Transaction', 'Bills Payment', 'Human Resource', 'Reimbursement', 'Bank Transfer'],
        'trans_category_label_filter_2' => ['All', 'Deposit Transaction', 'Bills Payment', 'Human Resource', 'Reimbursement', 'Bank Transfer'],
        'trans_category_label_make_form' => ['Make Form', 'Make Form', 'Make Form', 'Make Form', 'Reimbursement', 'Bank Transfer'],
        'status_filter' => [
            ['Generated', '1,5'],
            ['For Approval', '6'],
            ['Issued', '4'],
