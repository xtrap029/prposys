                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <table class="table table-sm">
                                        ...
                                        @if ($transaction->autogenerated_transaction)
                                            <tr>
                                                <td class="font-weight-bold">Payor Name</td>
                                                <td>
                                                    {{ $transaction->autogenerated_transaction->project->company->name }}
                                                </td>
                                            </tr>
                                        @else
                                            ...
                                            @endif
                                            <tr>
                                                <td class="font-weight-bold">Payee Name</td>
                                                <td>
