            ...
            <div class="row"> 
                ...
                <div class="mt-4 w-100 d-lg-none">
                    <div class="row">
                        ...
                        <div class="col-4 px-1 {{ $perms['can_hierarchy_disapprove'] ? '' : 'd-none' }}">
                    ...
                    @if ($perms['can_hierarchy_disapprove'])
                        <div class="modal fade" id="modal-hierarchy-disapprove" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <div class="modal-header border-0">
                                        <h5 class="modal-title">Disapprove Transaction</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body text-center">
                                        <form action="/transaction-form/hierarchy-disapprove/{{ $transaction->id }}" method="post">
                                            @csrf
                                            @method('put')
