            ...
            @if ($transaction)
                <form action="" method="post" class="col-md-7">
                    ...
                    <div class="alert alert-dark rounded">
                        ...
                        will be <code>GENERATED</code>.
                    </div>
                    <div class="form-group">
                        <input type="password" name="password" class="form-control" placeholder="{{ __('messages.password_required') }}" required>
                    </div>
                    <div class="form-group">
                        <input type="submit" value="Force Renew" class="btn btn-primary">
                        <a href="/control-panel/force-renew/" class="float-right btn btn-secondary">Cancel</a>
                    </div>
                </form>
            @else
