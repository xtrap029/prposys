            ...
            <form action="/travels/{{ $travel->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <select id="travels_request_type_id" name="travels_request_type_id" class="form-control" required>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control @error('date_from') is-invalid @enderror" name="date_from" value="{{ $travel->date_from }}" required>
                        @include('errors.inline', ['message' => $errors->first('date_from')])
                    </div>
                    <div class="form-group col-md-3">
                        <label for="">Date To</label>
                        <input type="date" class="form-control @error('date_to') is-invalid @enderror" name="date_to" value="{{ $travel->date_to }}" required>
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea class="form-control" name="traveling_users_static" rows="2" required>{{ $travel->traveling_users_static }}</textarea>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table bg-white" style="min-width: 1000px">
                                            ...
                                            <tbody class="jsReplicate_container">
                                                @if (isset($travel->passengers[0]))
                                                    <tr class="jsReplicate_template_item">
                                                        <td>
                                                            <select name="passenger_id[]" class="form-control">
                                                                @foreach ($users as $item)
                                                                    <option value="{{ $item->id }}" {{ $travel->passengers[0]->user->id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                @endforeach
                                                                <optgroup label="Inactive" class="bg-gray-light">
                                                                    @foreach ($users_inactive as $item)
                                                                        <option value="{{ $item->id }}" class="bg-gray-light"  {{ $travel->passengers[0]->user->id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                            </select>
                                                        </td>
                                                        <td><input type="text" name="travel_no[]" class="form-control" value="{{ $travel->passengers[0]->travel_no }}" required></td>
                                                ...
                                                @endif
                                                @foreach ($travel->passengers as $key => $item)
                                                    @if ($key > 0)
                                                        <tr class="jsReplicate_template_item">
                                                            <td>
                                                                <select name="passenger_id[]" class="form-control">
                                                                    @foreach ($users as $item2)
                                                                        <option value="{{ $item2->id }}" {{ $item->user->id == $item2->id ? 'selected' : '' }}>{{ $item2->name }}</option>
                                                                    @endforeach
                                                                    <optgroup label="Inactive" class="bg-gray-light">
                                                                        @foreach ($users_inactive as $item2)
                                                                            <option value="{{ $item2->id }}" class="bg-gray-light"  {{ $item->user->id == $item2->id ? 'selected' : '' }}>{{ $item2->name }}</option>
                                                                        @endforeach
                                                                    </optgroup>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" name="travel_no[]" class="form-control" value="{{ $item->travel_no }}" required></td>
                                                            <td><button type="button" class="btn btn-danger jsReplicate_remove"><i class="nav-icon material-icons icon--list">delete</i></button></td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="form-group jsReplicate">
                                        <div class="table-responsive">
                                            <table class="table bg-white" style="min-width: 1000px">
                                                ...
                                                <tbody class="jsReplicate_container">
                                                    @if (isset($travel->flights[0]))
                                                        <tr class="jsReplicate_template_item jsSum">
                                                            <td class="font-weight-bold text-center jsReplicate_order">1</td>
                                                            <td>
                                                                <div class="form-row">
                                                                    <div class="col-6 mb-2">
                                                                        <input type="text" name="f_airline[]" class="form-control" placeholder="Airline" value="{{ $travel->flights[0]->name }}" required>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <input type="text" name="f_remarks[]" class="form-control" placeholder="Remarks" value="{{ $travel->flights[0]->remarks }}" required>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <input type="datetime-local" name="f_in[]" class="form-control" placeholder="Time Flight In" value="{{ $travel->flights[0]->time_in }}" required>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <input type="datetime-local" name="f_out[]" class="form-control" placeholder="Time Flight Out" value="{{ $travel->flights[0]->time_out }}" required>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-row">
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="f_airfare[]" class="form-control jsSum_item" placeholder="Airfare" step="0.01" value="{{ $travel->flights[0]->fee }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="f_car[]" class="form-control jsSum_item" placeholder="Car Rental" step="0.01" value="{{ $travel->flights[0]->fee_car }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="f_baggage[]" class="form-control jsSum_item" placeholder="Baggage Fee" step="0.01" value="{{ $travel->flights[0]->fee_baggage }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="f_land[]" class="form-control jsSum_item" placeholder="Land Expenses" step="0.01" value="{{ $travel->flights[0]->fee_land }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        @if ($key > 0)
                                                            <tr class="jsReplicate_template_item jsSum">
                                                                ...
                                                                <td>
                                                                    <div class="form-row">
                                                                        <div class="col-6 mb-2">
                                                                            <input type="text" name="f_airline[]" class="form-control" placeholder="Airline" value="{{ $item->name }}" required>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <input type="text" name="f_remarks[]" class="form-control" placeholder="Remarks" value="{{ $item->remarks }}" required>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <input type="datetime-local" name="f_in[]" class="form-control" placeholder="Time Flight In" value="{{ $item->time_in }}" required>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <input type="datetime-local" name="f_out[]" class="form-control" placeholder="Time Flight Out" value="{{ $item->time_out }}" required>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-row">
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="f_airfare[]" class="form-control jsSum_item" placeholder="Airfare" step="0.01" value="{{ $item->fee }}" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="f_car[]" class="form-control jsSum_item" placeholder="Car Rental" step="0.01" value="{{ $item->fee_car }}" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="f_baggage[]" class="form-control jsSum_item" placeholder="Baggage Fee" step="0.01" value="{{ $item->fee_baggage }}" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="f_land[]" class="form-control jsSum_item" placeholder="Land Expenses" step="0.01" value="{{ $item->fee_land }}" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                    ...
                                    <div class="form-group jsReplicate">
                                        <div class="table-responsive">
                                            <table class="table bg-white" style="min-width: 1000px">
                                                ...
                                                <tbody class="jsReplicate_container">
                                                    @if (isset($travel->hotels[0]))
                                                        <tr class="jsReplicate_template_item jsSum">
                                                            <td class="font-weight-bold text-center jsReplicate_order">1</td>
                                                            <td>
                                                                <div class="form-row">
                                                                    <div class="col-6 mb-2">
                                                                        <input type="text" name="h_name[]" class="form-control" placeholder="Name" value="{{ $travel->hotels[0]->name }}" required>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <input type="text" name="h_remarks[]" class="form-control" placeholder="Remarks" value="{{ $travel->hotels[0]->remarks }}" required>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-row">
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="h_rate[]" class="form-control jsSum_item" placeholder="Hotel Rate" step="0.01" value="{{ $travel->hotels[0]->fee }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="h_car[]" class="form-control jsSum_item" placeholder="Car Rental" step="0.01" value="{{ $travel->hotels[0]->fee_car }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mb-2">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="number" name="h_land[]" class="form-control jsSum_item" placeholder="Land Expenses" step="0.01" value="{{ $travel->hotels[0]->fee_land }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        @if ($key > 0)
                                                            <tr class="jsReplicate_template_item jsSum">
                                                                ...
                                                                <td>
                                                                    <div class="form-row">
                                                                        <div class="col-6 mb-2">
                                                                            <input type="text" name="h_name[]" class="form-control" placeholder="Name" value="{{ $item->name }}" required>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <input type="text" name="h_remarks[]" class="form-control" placeholder="Remarks" value="{{ $item->remarks }}" required>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-row">
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="h_rate[]" class="form-control jsSum_item" placeholder="Hotel Rate" step="0.01" value="{{ $item->fee }}" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="h_car[]" class="form-control jsSum_item" placeholder="Car Rental" step="0.01" value="{{ $item->fee_car }}" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6 mb-2">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="number" name="h_land[]" class="form-control jsSum_item" placeholder="Land Expenses" step="0.01" value="{{ $item->fee_land }}" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
        ...
        $(function() {
            ...
            if($('#travels_request_type_id')[0]) {
                ...
                $('#travels_request_type_id').on('change', function() {    
                    ...
                    showFlightHotelOption($(this).val())
                })
                
                showFlightHotelOption($('#travels_request_type_id')[0].value)

                function showFlightHotelOption(id) {
                    switch (id) {
                        case '1':
